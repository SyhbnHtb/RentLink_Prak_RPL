export default function RiwayatPembayaran() {
  return (
    <div className="min-w-screen min-h-screen">
      <button className="cursor-pointer text-nowrap inline-flex py-1 px-3 justify-center items-center gap-2.5 rounded-xl bg-[#8F8383] absolute left-[1962px] top-[301px]">
        <p className="text-[#FFF] font-roboto text-xl absolute left-3 top-1">
          Selesai
        </p>
      </button>
