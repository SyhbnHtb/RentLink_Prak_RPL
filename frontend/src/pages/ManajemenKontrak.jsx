export default function ManajemenKontrak() {
  return (
    <div className="min-w-screen min-h-screen">
      <div className="inline-flex items-center gap-10 absolute left-[1976px] top-[935px]">
        <button className="cursor-pointer text-nowrap flex py-1 px-3 justify-center items-center gap-2.5 rounded-xl bg-[#28A745] absolute left-0 top-0">
          <p className="text-[#FFF] font-roboto text-xl w-fit">Aktif</p>
        </button>
        <button className="cursor-pointer text-nowrap flex py-1 px-3 justify-center items-center gap-2.5 rounded-xl bg-[#8F8383] absolute left-[106px] top-0">
      ...
      <div className="flex p-2.5 flex-col items-start gap-2.5 rounded-[12.3px] border-2 border-[#B0E4CC] bg-[#FFF] w-[359px] absolute left-[1976px] top-[462px]">
        ...
        <div className="flex flex-col items-start w-[309px]">
          <div className="flex flex-col items-start w-full">
            <p className="text-[#408A71] font-plusJakartaSans text-xs font-bold w-full tracking-[0.0342em]">
              Email
            </p>
          </div>
          <div className="flex flex-col items-start w-full">
      ...
      <div className="flex p-2.5 flex-col items-start gap-2.5 rounded-[12.3px] border-2 border-[#B0E4CC] bg-[#FFF] w-[359px] absolute left-[2391px] top-0">
        <div className="flex flex-col items-start w-[332px]">
          ...
          <div className="inline-grid py-2 px-[19px] rounded-xl bg-[rgba(63,63,63,0.10)] w-full relative">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="w-5 h-5 absolute left-[19px] top-2 overflow-hidden "
            >
              <path
            ...
            <p className="flex flex-col justify-center text-[rgba(0,0,0,0.65)] font-sora text-[19px] font-semibold w-[167px] h-5 absolute left-[120px] top-2">
              Pilih Unit...
            </p>
          </div>
          <div className="inline-grid py-2 px-[19px] bg-[rgba(63,63,63,0.10)] w-full relative">
            <p className="text-[rgba(0,0,0,0.65)] font-sora text-[19px] font-semibold absolute left-[120px] top-2">
              Kamar
            </p>
            <p className="text-[rgba(0,0,0,0.65)] font-sora text-[19px] font-semibold absolute left-[250px] top-2">
              102
            </p>
          </div>
          <div className="inline-grid py-2 px-[19px] rounded-xl bg-[rgba(63,63,63,0.10)] w-full relative">
            ...
            <div className="flex flex-col justify-center items-center gap-4 rounded-2xl bg-[#FFF] shadow-[04px4px0rgba(0,0,0,0.25)] w-fit overflow-hidden">
              <div className="flex justify-center items-center bg-[#F9FAFB] w-fit overflow-hidden">
                <div className="flex flex-col items-start w-fit h-[472px]">
                  ...
                  <div className="flex py-0 px-5 items-center gap-3 shrink-0 border-b border-b-[#D9EBFE] bg-[#F9FAFB] w-[163px] h-10">
                    <p className="text-[#285A48] font-roboto text-xl w-fit">
                      C-001
                    </p>
                  </div>
                  <div className="flex py-0 px-5 items-center gap-3 shrink-0 border-b border-b-[#D9EBFE] bg-[#F3F8FF] w-[163px] h-10">
                    <p className="text-[#285A48] font-roboto text-xl w-fit">
                      C-002
                    </p>
                  </div>
                ...
                <div className="flex flex-col items-start w-fit h-[472px]">
                  ...
                  <div className="flex py-0 px-5 items-center gap-3 shrink-0 border-b border-b-[#D9EBFE] bg-[#F9FAFB] w-[159px] h-10">
                    <p className="text-[#285A48] font-roboto text-xl w-fit">
                      Kamar 201
                    </p>
                  </div>
                  <div className="flex py-0 px-5 items-center gap-3 shrink-0 border-b border-b-[#D9EBFE] bg-[#F3F8FF] w-[159px] h-10">
                    <p className="text-[#285A48] font-roboto text-xl w-fit">
                      Kamar 102
                    </p>
                  </div>
                ...
                <div className="flex flex-col items-start w-fit h-[472px]">
                  ...
                  <div className="flex py-0 px-5 items-center gap-3 shrink-0 border-b border-b-[#D9EBFE] bg-[#F9FAFB] w-[120px] h-10">
                    <p className="text-[#285A48] font-roboto text-xl w-fit">
                      2
                    </p>
                  </div>
                  <div className="flex py-0 px-5 items-center gap-3 shrink-0 border-b border-b-[#D9EBFE] bg-[#F3F8FF] w-[120px] h-10">
                    <p className="text-[#285A48] font-roboto text-xl w-fit">
                      1
                    </p>
                  </div>
                ...
                <div className="flex flex-col items-start w-[220px] h-[472px]">
                ...
                <div className="flex flex-col items-start rounded-[20px] w-fit h-[472px]">
                  ...
                  <div className="flex py-0 px-5 justify-between items-center shrink-0 border-b border-b-[#D9EBFE] bg-[#F3F8FF] w-full h-10">
                    <div className="flex py-1 px-2 items-center gap-1 rounded-xl w-fit">
                      <p className="text-[#285A48] font-roboto text-xl w-fit">
                        Detail
                      </p>
                    ...
                    <div className="flex py-1 px-2 items-center gap-1 rounded-xl w-fit">
                      <p className="text-[#DC3545] font-roboto text-xl"> </p>
                    </div>
                  </div>
                </div>
              </div>
